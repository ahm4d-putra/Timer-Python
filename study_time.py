...
class StudyTimerApp(tk.Tk):
    ...
    def __init__(self) -> None:
        ...
        self.configure(padx=16, pady=16, bg="#dbe9f4")  # soft light blue background
...
if __name__ == "__main__":
    style = ttk.Style()
    style.configure("Custom.TFrame", background="#dbe9f4")  # soft light blue background for frames
